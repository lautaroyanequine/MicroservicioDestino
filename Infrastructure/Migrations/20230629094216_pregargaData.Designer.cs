...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20230629094216_pregargaData")]
    partial class pregargaData
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.InfoCiudad", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            InfoCiudadId = 1,
                            CiudadId = 1,
                            Descripcion = "La ciudad de La Plata, ubicada en la provincia de Buenos Aires, Argentina, es un centro urbano vibrante y cosmopolita que combina una rica historia con un ambiente moderno y dinámico. Conocida como la ciudad de las diagonales, La Plata se destaca por su diseño urbano único, con amplias avenidas y calles diagonales que se cruzan en un patrón geométrico fascinante.La ciudad es reconocida por albergar una de las universidades más prestigiosas de América Latina, la Universidad Nacional de La Plata, lo que le confiere una energía juvenil y académica. Además, cuenta con una gran cantidad de institutos de investigación y centros culturales que fomentan la actividad intelectual y artística.La Plata ofrece una gran variedad de opciones culturales y de entretenimiento. Sus numerosos teatros, museos y galerías de arte exhiben tanto obras clásicas como contemporáneas, y la ciudad alberga festivales de música, danza y cine a lo largo del año.Los espacios verdes son otro aspecto destacado de La Plata. El Paseo del Bosque, un hermoso parque de gran extensión, es el pulmón verde de la ciudad y ofrece un lugar tranquilo para pasear, hacer deporte o disfrutar de un picnic. Además, la ciudad cuenta con plazas y espacios públicos bien cuidados que invitan a la interacción social y al descanso.La arquitectura de La Plata es diversa y cautivadora. Desde la majestuosidad de la Catedral de La Plata, con su estilo neogótico, hasta los edificios modernos y vanguardistas, la ciudad combina elementos históricos con la vanguardia arquitectónica.La gastronomía también es un punto fuerte de La Plata. La ciudad ofrece una amplia variedad de restaurantes, bares y cafeterías que satisfacen todos los gustos y presupuestos, desde platos típicos argentinos hasta cocina internacional.",
                        ...
                        new
                        {
                            InfoCiudadId = 2,
                            CiudadId = 2,
                            Descripcion = "Mar del Plata, ubicada en la costa atlántica de Argentina, es una ciudad costera vibrante y turística que combina hermosas playas, entretenimiento y una amplia oferta cultural. Conocida como <La Perla del Atlántico>, Mar del Plata atrae a visitantes de todo el país y del extranjero.Sus extensas playas son el principal atractivo de la ciudad, ofreciendo arenas blancas y aguas cristalinas que invitan a disfrutar del sol y el mar. Además, Mar del Plata cuenta con una amplia infraestructura turística, con hoteles, restaurantes y servicios de calidad para satisfacer las necesidades de los visitantes.La ciudad también ofrece una variada oferta de entretenimiento. El famoso Casino Central de Mar del Plata es un ícono de la ciudad y atrae a aquellos que buscan disfrutar de la emoción del juego. Además, los teatros, cines y centros culturales brindan una amplia oferta de espectáculos, películas y exposiciones artísticas.La ciudad también ofrece una variada oferta de entretenimiento. El famoso Casino Central de Mar del Plata es un ícono de la ciudad y atrae a aquellos que buscan disfrutar de la emoción del juego. Además, los teatros, cines y centros culturales brindan una amplia oferta de espectáculos, películas y exposiciones artísticas.La ciudad también ofrece una variada oferta de entretenimiento. El famoso Casino Central de Mar del Plata es un ícono de la ciudad y atrae a aquellos que buscan disfrutar de la emoción del juego. Además, los teatros, cines y centros culturales brindan una amplia oferta de espectáculos, películas y exposiciones artísticas.En resumen, Mar del Plata es una ciudad costera que combina playas hermosas, entretenimiento, cultura y una animada vida nocturna. Con su amplia oferta turística, brinda a los visitantes la posibilidad de relajarse, divertirse y disfrutar de una experiencia única junto al mar.",
